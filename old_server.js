...
const { TEXT_CSS, TEXT_JAVASCRIPT, APPLICATION_JSON, IMAGE_JPEG, IMAGE_PNG, TEXT_PLAIN, TEXT_HTML } = require('./constants/contentTypes')
...
const serveFile = async (filePath, contentType, response) => {
  try {
    ...
    const data = contentType === APPLICATION_JSON
      ? JSON.parse(rawData)
      : rawData
    response.writeHead(
